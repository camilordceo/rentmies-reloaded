...
<div class="building-overlay"><h3>Proyecto Gorrión de Prodsa</h3><p>Desde $190.000.000</p></div>
...
<div data-reveal="right"><div class="calc-card"><div class="calc-label">Calculadora de Cashback</div><div class="calc-slider-wrap"><div class="calc-price-display" id="calcPrice">$500.000.000</div><input type="range" class="calc-slider" id="calcSlider" min="100000000" max="2000000000" step="25000000" value="500000000" aria-label="Precio de la propiedad"><div style="display:flex;justify-content:space-between;margin-top:6px"><span style="font-size:.75rem;color:var(--sec)">$100M</span><span style="font-size:.75rem;color:var(--sec)">$2.000M</span></div></div><div class="calc-results"><div class="calc-row"><span class="calc-row-l">Precio de venta</span><span class="calc-row-v" id="calcPurchase">$500.000.000</span></div><div class="calc-row"><span class="calc-row-l">Comisión Rentmies (1.5%)</span><span class="calc-row-v" id="calcCommission">$7.500.000</span></div><div class="calc-row"><span class="calc-row-l">Cashback comprador (1%)</span><span class="calc-row-v hl" id="calcCashback">$5.000.000</span></div></div><div class="calc-note"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg>Pagado al comprador 1 semana después del cierre</div></div></div></div></div></section>
...
<footer><div class="container"><p>&copy; 2026 Rentmies. Invertimos en agencias que invierten en sí mismas.</p></div></footer>
...
<div class="form-slots"><span class="slots-badge">Solo 10 cupos</span> — aplicaciones revisadas en 24 horas</div>
</div></div>
